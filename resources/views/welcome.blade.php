    ...
    <section class="hero">
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center vh-100">
                <div class="col-md-6">
                <span class="badge1">Pinjam buku favorit Anda dengan mudah</span>
                    <h1 class="fw-bold mt-3">Nikmati Meminjam Buku Secara Online!</h1>
<p>Temukan kemudahan meminjam buku favorit Anda kapan saja dan di mana saja. Jadikan membaca lebih praktis dan menyenangkan!</p>
                    ...
                    <div class="row alasan d-flex justify-content-center align-items-center shadow-lg">
                        <div class="col-md-4">
                            <div class="p-4 text-center">
                                ...
                                <h5 class="fw-bold m-2">PEMINJAMAN BUKU GRATIS</h5>
<p>Pinjam buku favorit Anda tanpa biaya apapun. Nikmati membaca dan perluas wawasan Anda.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-4 text-center">
                                <i class="bi bi-hand-thumbs-up-fill icon"></i>
                                <h5 class="fw-bold m-2">100% KEPUASAN</h5>
                                <p>Kami memastikan Anda mendapatkan buku berkualitas dengan layanan terbaik. Kepuasan Anda adalah prioritas kami.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-4 text-center">
                                <i class="bi bi-browser-safari icon"></i>
                                <h5 class="fw-bold m-2">PROSES PENGEMBALIAN MUDAH</h5>
                                <p>Proses pengembalian buku dirancang mudah dan praktis. Tidak perlu khawatir tentang kesulitan pengembalian.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<p>Pinjam buku dengan cepat dan praktis di platform kami.</p>
                    ...
                    <div class="card border-0 p-5" >
                        ...
                        <div class="row d-flex justify-content-center text-center mb-3">
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    ...
                                    <h6 class="mt-3 fw-semibold">AR</h6>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    <img src="{{ asset('image/hero.png') }}" width="100" alt="">
                                    <h6 class="mt-3 fw-semibold">laravel</h6>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    <img src="{{ asset('image/hero.png') }}" width="100" alt="">
                                    <h6 class="mt-3 fw-semibold">CI4</h6>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center text-center">
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    <img src="{{ asset('image/hero.png') }}" width="100" alt="">
                                    <h6 class="mt-3 fw-semibold">YOLO</h6>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    <img src="{{ asset('image/hero.png') }}" width="100" alt="">
                                    <h6 class="mt-3 fw-semibold">BASIS DATA</h6>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card-book p-2">
                                    <img src="{{ asset('image/hero.png') }}" width="100" alt="">
                                    <h6 class="mt-3 fw-semibold">REACT</h6>
                                </div>
                            </div>
                        </div>
                    </div>
